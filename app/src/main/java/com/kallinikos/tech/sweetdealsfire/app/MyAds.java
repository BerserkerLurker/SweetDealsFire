...
import com.kallinikos.tech.sweetdealsfire.adapters.MyAdsAdapter;
 ...
 */
public class MyAds extends Fragment implements Callbackmyads{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new MyAdsAdapter(this.getActivity(), new ArrayList<AdImage>());
    ...
    public void onStart() {
        ...
        adapter.setOnItemClickListener(new MyAdsAdapter.ClickListener() {
            @Override
    ...
    public void setList(){
        final DatabaseReference mRefFavs = mref.child("users").child(userId).child("ads");
        ...
        for (int i=0;i<keys.size();i++){
            ...
            mrefAds.child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    adapter.updateAdapter(dataSnapshot.getKey(),ad.getTitle(),ad.getPrice(),ad.getDescription(),ad.getCategory(),ad.getSubcategory(),listImgURL);
                }
